...
- номер задачи должен совпадать с номером `Issue`
- использовать короткое описание в `kebab-case`
- название ветки должно быстро объяснять суть задачи

### Создание ветки

Предпочтительно: создавать ветку из `Issue`, чтобы задача, ветка и дальнейший PR были связаны между собой.

`Issue -> Development -> Checkout locally`
