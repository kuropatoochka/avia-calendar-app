import type { AirportOption, PassengersState, ServiceClass, TripType } from './types';
import type { Dayjs } from 'dayjs';
import { useState, useCallback } from 'react';
import { AirportService } from '@/shared/api';
import { DATA_SOURCE } from '@/shared/consts';
import { DEFAULT_PASSENGERS } from './defaults';
import { mapAirportToOption } from './map-airport-to-option';
