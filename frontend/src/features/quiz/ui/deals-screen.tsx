...
// Mock airport IDs (MSW / generateFlights) — same as real DB since airport-mock.ts uses IDs 1-27
...
// Mock: all 25 cities — same airport IDs as real DB (airport-mock.ts uses 1-27)
