...
CITIES = {
    ...
    "Петрозаводск":       (True,  False, True),   # Карелия
    "Горно-Алтайск":      (False, False, True),   # Алтай
    "Улан-Удэ":           (False, False, True),   # Байкал
    "Петропавловск-Камчатский": (True, False, True),  # Камчатка
    "Махачкала":          (True,  True,  True),   # Дагестан
}
...
ROUTES = [
    ...
    # Quiz destinations
    ("Москва",           "Петрозаводск",    90,   "alt",    [0,4],   [4,5]),   # Карелия
    ...
    ("Москва",           "Горно-Алтайск",   250,  "weekly", [0,1],   [2,4]),   # Алтай
    ("Горно-Алтайск",    "Москва",          250,  "weekly", [0,1],   [2,4]),
    ("Москва",           "Улан-Удэ",        340,  "weekly", [0,1],   [1,6]),   # Байкал
    ("Улан-Удэ",         "Москва",          340,  "weekly", [0,1],   [1,6]),
    ("Москва",           "Петропавловск-Камчатский", 510, "weekly", [0], [6,7]),  # Камчатка
    ("Петропавловск-Камчатский", "Москва",  510,  "weekly", [0],     [6,7]),
    ("Москва",           "Махачкала",       155,  "alt",    [0,4],   [0,2]),   # Дагестан
    ("Махачкала",        "Москва",          155,  "alt",    [0,4],   [0,2]),
    # Previously unreachable cities
